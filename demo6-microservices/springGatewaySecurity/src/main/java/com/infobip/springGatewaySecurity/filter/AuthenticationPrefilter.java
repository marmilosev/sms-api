...
import com.infobip.springGatewaySecurity.model.Authorities;
        ...
        return (exchange, chain) -> {
            ...
            if(isSecured.test(request)) {
                return webClientBuilder.build().get()
                        .uri("lb://authenticationService/api/v1/validateToken")
                        .header("header", bearerToken)
...
//        ObjectMapper objMapper = new ObjectMapper();
        ...
        try {
            ...
            Exception data = new Exception("error");
